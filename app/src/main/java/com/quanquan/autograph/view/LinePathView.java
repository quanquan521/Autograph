package com.quanquan.autograph.view;
...
public class LinePathView extends View {
     ...
     *
     */
    public void send(String login_user, String password, boolean clearBlank, int blank, final BooleanCallbackWithException callback) {
        ...
        if (buffer != null) {
            HttpUtlis.PostSendData(login_user, password, buffer, new BooleanCallbackWithException() {
                @Override
